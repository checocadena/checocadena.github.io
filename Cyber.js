...
function preload() {
  img = loadImage('Cyber/CyberProphet.png'); //images 1 to 3 are custom assets
  img2 = loadImage('Cyber/CyberProphet_Mouth.png');
  img3 = loadImage('Cyber/Evil.png');
  img4  = loadImage('Cyber/Hell.gif'); // taken from https://danielleranucci.wordpress.com/2021/10/05/lit-in-the-time-of-coronavirus-strindberg-gombrowicz-and-ibsen/
  img5 = loadImage('Cyber/Heaven.png');
  soundFormats('mp3');
  fire = loadSound('Cyber/fire-1.mp3'); // taken from https://www.soundjay.com/fire-sound-effects.html#google_vignette
  boot = loadSound('Cyber/Boot.mp3') // taken from  https://pixabay.com/sound-effects/mystery-dream-vocal-chord-94868/
  angel = loadSound('Cyber/Angel.mp3')// taken from https://pixabay.com/sound-effects/ahhhh-37191/
}

function setup() {
  new Canvas(windowWidth, windowHeight); //Window Width and Height
  talkingBeing = loadAnimation( //Talking CyberProphet
		'Cyber/CyberProphet.png',
		'Cyber/CyberProphet_Mouth.png',
	);
